...
def drawTicks():
    ...
    for x in range(0, divisionsX+1):
        #print('x:', x , int((x*multi/2000)), (x*offsetX, -10))
        graph.DrawLine((x*offsetX, -3), (x*offsetX, 3))
        graph.DrawText(int((x*multi/2000)), (x*offsetX, -10), color='black')
